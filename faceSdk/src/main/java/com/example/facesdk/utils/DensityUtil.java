...
import static com.example.facesdk.GlobalSet.TYPE_PREVIEW_TWO_HUNDERED_SEVENTY_ANGLE;
...
public final class DensityUtil {
	...
	public static String calculateCameraView(Context context) {
		...
		int layoutHeight = DensityUtil.getScreenHeight(context) - DensityUtil.dip2px(context, 0);
		// 设置的角度
