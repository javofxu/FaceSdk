...
public class UserInfoManager {
     ...
     * @param listener
     */
    public int getFeatureInfoMsg(final String keyWords, final UserInfoListener listener) {
        mExecutorService.submit(new Runnable() {
            @Override
            public void run() {
                listener.featureQueryNumber(DBManager.getInstance().queryFeatureByName(keyWords));
            }
        });
        return listener.featureQueryNumber(DBManager.getInstance().queryFeatureByName(keyWords));
    }
    ...
    public static class UserInfoListener {
        ...
        public int featureQueryNumber(List<Feature> listFeatureInfo) {
            return listFeatureInfo.size();
        }
    }
}
